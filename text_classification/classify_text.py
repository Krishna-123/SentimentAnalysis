...
with open('new_dataset.json') as json_data:
...
#  these 2 lines are used to save the data 
#model.fit(train_x, train_y, n_epoch=1000, batch_size=8, show_metric=True)
#model.save('model.tflearn')
# if we have the dataset in the form of graph then we dont need to make it again and thus we can use the 
  # previous dataset
...
# sent_4 = "I'm sorry can you tell me the time"
...
def get_sentence(sentence):
    category = categories[np.argmax(model.predict([get_tf_record(sentence)]))]
    return category
